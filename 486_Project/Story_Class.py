...
class Story:
    ...
    def intro(self):
        # Brave hero, you are about to begin your journey and become a part of a tale as old as time of good versus evil.
        # In order to save the land you must defeat the dragon that plagues us, corrupting the land and it's inhabitants.

        print("""There are countless stories within this world, each with their own kind of ending whether it be good, bad, or somewhere in-between.
    ...
    def final_dialogue(self):
        return """This feeling of corruption is overwhelming and suffocating. In the distance you can see the source of suffering and cause of corruption itself."""
...
$$ |      $$  __$$ |$$ |      $$  _$$<  $$ |$$ |  $$ | \____$$\   $$ |$$\ $$   ____|$$ |      
$$$$$$$$\ \$$$$$$$ |\$$$$$$$\ $$ | \$$\ $$ |\$$$$$$  |$$$$$$$  |  \$$$$  |\$$$$$$$\ $$ |      
\________| \_______| \_______|\__|  \__|\__| \______/ \_______/    \____/  \_______|\__|   
